...
class Picking(models.Model):
    ...
    attachment_ids = fields.Many2many(comodel_name='ir.attachment', relation='atthacments_for_pickings',column1='picking_id', column2='att_id',string='Incoming Attachments')
    outgoing_attachment_ids = fields.Many2many(comodel_name='ir.attachment', relation='attachments_outgoing_for_pickings',column1='picking_id', column2='att_id',string='Outgoing Attachments')
